...
let g:vim_bootstrap_langs = "elixir,javascript,python,ruby,typescript"
...
" command! ProjectFiles execute 'GFiles --exclude-standard --others --cached' s:find_git_root()
...
nnoremap <silent> <Leader>rgg :Rg <C-R><C-W><CR>
